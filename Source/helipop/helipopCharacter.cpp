...
AhelipopCharacter::AhelipopCharacter()
{
	...
	// MeshLegLeft = CreateDefaultSubobject<USkeletalMeshComponent>(TEXT("MeshLegLeft"));
	// MeshLegRight = CreateDefaultSubobject<USkeletalMeshComponent>(TEXT("MeshLegRight"));
}
